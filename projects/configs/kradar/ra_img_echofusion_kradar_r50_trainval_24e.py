...
polar_pcd_range = [0, -pi*20/180, -2.0, 72.0, pi*20/180, 6.0]
polar_voxel_size = [72/192, pi*40/180/64, 0.4]
radius_range = [0., 72., 72/192]  # [start, end, interval]
grid_res = 0.4
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file=data_root + 'kradar_infos_trainval.pkl',
            split='',
    ...
    test=dict(type=dataset_type, 
              data_root=data_root,
              ann_file=data_root + 'kradar_infos_test.pkl',
              split='',
              pipeline=test_pipeline,
              classes=class_names, 
              modality=input_modality,
