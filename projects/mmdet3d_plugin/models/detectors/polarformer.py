...
class PolarFormer(MVXTwoStageDetector):
    """PolarFormer."""
    ...
    def extract_img_feat(self, img, img_metas, gt_bboxes_3d, gt_labels_3d):
    ...
    def extract_feat(self, img, img_metas, gt_bboxes_3d, gt_labels_3d):
    ...
    def forward_train(self,
        ...
        Args:
            ...
            img (torch.Tensor optional): Images of each sample with shape
                (B, N, C, H, W). Defaults to None. N: default=6, 6 cameras.
