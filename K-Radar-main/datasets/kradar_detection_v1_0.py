    ...
    def show_rpc_cfar_with_lpc(self, dict_item, is_with_dop=True, type_filter=None):
        ...
        *   roi = self.roi_label
        ...
        if is_with_dop:
            ...
            rpc = self.cfar.os_cfar(dict_item['rdr_cube'])
...
if __name__ == '__main__':
    ...
    path_cfg = './configs/cfg_RTNH_vanilla_1-20.yml'
    ...
    # dataset.show_rpc_cfar_with_lpc(dict_item, is_with_dop=False, type_filter='ror')
    ### Rdr spcube (GET_ITEM['rdr_sp_cube']: True)
